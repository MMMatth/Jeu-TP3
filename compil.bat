...
gcc tests/joueur_test.c lib/*.o -o bin/joueur_test -I include/SDL -L lib/SDL -lmingw32 -lSDL2main -lSDL2
gcc tests/monstre_test.c lib/*.o -o bin/monstre_test -I include/SDL -L lib/SDL -lmingw32 -lSDL2main -lSDL2
gcc tests/main_test.c lib/*.o -o bin/main_test -I include/SDL -L lib/SDL -lmingw32 -lSDL2main -lSDL2
